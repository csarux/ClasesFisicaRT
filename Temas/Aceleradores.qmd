...
::: {.columns}
:::: {.column width="50%"}
![Estativo y cabezal](images/GantryAndStand.png){fig-align="left" height="500px"}
::::
:::: {.column width="50%"}
![Modulador. En este diseño el modulador no está integrado en el estativo.](images/ModulatorReal.png){fig-align="left" height="500px"}
::::
:::
...
::: {.columns}
:::: {.column width="50%"}
![Cuba contenedora del klystron](images/CubaKlystronReal.png){fig-align="left" height="500px"}
::::
:::: {.column width="50%"}
![Salida del klystron. Los tubos de colores forman parte del circuito de refrigeración](images/SalidKlystronReal.png){fig-align="left" height="500px"}
::::
:::
...
::: {.columns}
:::: {.column width="50%"}
![Divisor de potencia. El brazo inferior termina en una carga de agua.](images/PowerSplitterReal.png){fig-align="left" height="500px"}
::::
:::: {.column width="50%"}
![Vista al otro lado de la salida del klystron en la que se ve el extremo de la carga de agua.](images/WaterLoadReal.png){fig-align="left" height="500px"}
::::
:::
...
::: {.columns}
:::: {.column width="50%"}
![Detalle de la guía de ondas rectangular que transporta la potencia hasta la guía de aceleración](images/GuiaRectangularReal.png){fig-align="left" height="500px"}
::::
:::: {.column width="50%"}
![Detalle del acople de la guía de ondas rectangular con el cilindro centrado con el eje de giro del cabezal](images/WaterLoadAndRectangularWaveGuideReal.png){fig-align="left" height="500px"}
::::
:::
...
::: {.columns}
:::: {.column width="50%"}
![Cabezal del acelerador sin carcasa y girado a 270º. El cilindro rojo es la sección de aceleración. La sección de deflexión está contenida bajo la estructura blindada en el extremos del cabezal.](images/GuiaAceleracionReal.png){fig-align="center" height="400px"}
::::
:::: {.column width="50%"}
![Cabezal del acelerador sin carcasa. En la parte inferior se aprecia la electrónica de control del MLC.](images/CabezalSinCarcasaReal.png){fig-align="center" height="400px"}
::::
:::
